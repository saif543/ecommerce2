                                ...
                                <form onSubmit={handleSaveProduct} className="p-6 space-y-6">
                                        ...
                                        <div className="grid grid-cols-5 gap-4">
                                            ...
                                            {imagePreviews.length < 20 && (
                                                <button
                                                    ...
                                                    className="w-full h-24 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center hover:border-[#FF6B35] hover:bg-orange-50 transition-all"
                                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                            ...
                                            {showCustomCategory && (
                                                <div className="flex gap-2 mt-2">
                                                    <input
                                                        ...
                                                        className="flex-1 px-3 py-2 border border-[#FF6B35] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#FF6B35]"
                                                    ...
                                                    }} className="px-3 py-2 bg-[#FF6B35] text-white rounded-lg text-sm">Save</button>
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B35] disabled:opacity-50"
                                            >
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            <input
                                                ...
                                                className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B35] text-sm"
                                            ...
                                            <button type="button" onClick={() => { if (newFeature.trim()) { setFormData({ ...formData, features: [...formData.features, newFeature.trim()] }); setNewFeature('') } }}
                                                className="px-4 py-2 bg-[#FF6B35] text-white rounded-lg hover:bg-[#E85A2A] transition-colors text-sm font-medium">Add</button>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                                        ...
                                                        <tr key={idx} className="border-t border-gray-100">
                                                            <td className="px-2 py-1.5">
                                                                <input
                                                                    ...
                                                                    className="w-full px-3 py-1.5 border border-gray-200 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-[#FF6B35]"
                                        ...
                                        <button type="button" onClick={() => setSpecPairs([...specPairs, { key: '', value: '' }])}
                                            className="mt-2 text-sm text-[#FF6B35] hover:underline flex items-center gap-1">
                                            + Add Row
                                        </button>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            <input type="text" value={customFieldKey} onChange={(e) => setCustomFieldKey(e.target.value)}
                                                className="w-1/3 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B35] text-sm" placeholder="Field name" />
                                            <input type="text" value={customFieldValue} onChange={(e) => setCustomFieldValue(e.target.value)}
                                                className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B35] text-sm" placeholder="Field value" />
                                            <button type="button" onClick={() => { if (customFieldKey.trim()) { setFormData({ ...formData, customFields: { ...formData.customFields, [customFieldKey.trim()]: customFieldValue } }); setCustomFieldKey(''); setCustomFieldValue('') } }}
                                                className="px-4 py-2 bg-[#FF6B35] text-white rounded-lg hover:bg-[#E85A2A] text-sm font-medium">Add</button>
                                        </div>
                                    </div>
