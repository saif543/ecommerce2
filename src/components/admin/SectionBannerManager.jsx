            ...
            <div className="px-6 pb-6">
                ...
                {preview ? (
                    <div className="space-y-3">
                        <div className="relative rounded-xl overflow-hidden border border-[#FF6B35]/40">
                            <img src={preview} alt="Preview" className="w-full h-24 min-[480px]:h-28 min-[640px]:h-32 object-cover" />
                            <div className="absolute top-2 left-2 bg-[#FF6B35] text-white text-[10px] font-semibold px-2 py-0.5 rounded">
                                Preview
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                disabled={uploading}
                                className="flex items-center gap-2 bg-[#FF6B35] hover:bg-[#E85A2A] text-white text-sm font-semibold px-5 py-2.5 rounded-lg transition-colors disabled:opacity-60 flex-1 justify-center"
                            >
                    ...
                    <label className="flex flex-col items-center justify-center w-full h-28 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:border-[#FF6B35] hover:bg-orange-50 transition-all group">
                        <ImageIcon size={24} className="text-gray-300 group-hover:text-[#FF6B35] transition-colors mb-2" />
                        <span className="text-xs font-medium text-gray-400 group-hover:text-[#FF6B35] transition-colors">
