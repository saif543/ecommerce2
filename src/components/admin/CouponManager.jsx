        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                        <Tag className="text-[#FF6B35]" size={26} />
                        Coupon Manager
                    </h2>
                ...
                <button
                    onClick={openCreate}
                    className="flex items-center gap-2 bg-[#FF6B35] hover:bg-[#E85A2A] text-white px-5 py-2.5 rounded-xl font-semibold shadow-md transition-colors"
                >
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/30 bg-white"
                />
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-20 text-gray-400 gap-3">
                        ...
                        <button onClick={openCreate} className="text-sm text-[#FF6B35] hover:underline font-medium">Create your first coupon</button>
                    </div>
                ) : (
                        ...
                        >
                                ...
                                <div className="flex gap-4">
                                    <div className="flex-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-mono uppercase focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/30"
                                        />
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div className="flex rounded-xl overflow-hidden border border-gray-200">
                                            <button
                                                ...
                                                className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 text-sm font-semibold transition-all ${form.discountType === 'percent' ? 'bg-[#FF6B35] text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
                                            >
                                                <Percent size={14} /> Percent
                                            </button>
                                            <button
                                                onClick={() => setForm(f => ({ ...f, discountType: 'flat' }))}
                                                className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 text-sm font-semibold transition-all ${form.discountType === 'flat' ? 'bg-[#FF6B35] text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
                                            >
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/30"
                                        />
                                    </div>
                                </div>
                                        ...
                                        <div className="flex flex-wrap gap-2 max-h-40 overflow-y-auto p-2 bg-gray-50 rounded-xl border border-gray-200">
                                            {categories.length === 0 ? (
                                                ...
                                                <button
                                                    ...
                                                    className={`px-3 py-1.5 rounded-lg text-xs font-semibold border transition-all ${form.categories.includes(cat.name) ? 'bg-[#FF6B35] border-[#FF6B35] text-white' : 'bg-white border-gray-200 text-gray-700 hover:border-gray-400'}`}
                                                >
                                                    {cat.name}
                                                </button>
                                            ))}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative mb-2">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-8 pr-4 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/30"
                                            />
                                        </div>
                                        <div className="max-h-52 overflow-y-auto border border-gray-200 rounded-xl divide-y divide-gray-100">
                                            {loadingProducts ? (
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className={`w-5 h-5 rounded-md border-2 flex items-center justify-center flex-shrink-0 transition-colors ${selected ? 'bg-[#FF6B35] border-[#FF6B35]' : 'border-gray-300'}`}>
                            ...
                            <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50 rounded-b-2xl">
                                ...
                                <button
                                    onClick={handleSave}
                                    disabled={saving}
                                    className="flex items-center gap-2 px-6 py-2.5 bg-[#FF6B35] hover:bg-[#E85A2A] text-white rounded-xl text-sm font-semibold shadow-md transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                                >
                                    {saving ? (
