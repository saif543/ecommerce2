                                ...
                                <div className="px-6 py-4 space-y-3">
                                    ...
                                    {preview && (
                                        <div>
                                            ...
                                            <div className="relative rounded-lg overflow-hidden border border-[#f26e21]/40">
                                            ...
                                            <div className="flex gap-2 mt-2">
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 bg-[#f26e21] hover:bg-[#C45A00] text-white text-xs font-semibold px-4 py-2 rounded-lg transition-colors disabled:opacity-60"
                                                >
                                    ...
                                    {/* File selector */}
                                    {!preview && (
                                        <label className="flex items-center gap-3 px-4 py-3 border border-dashed border-gray-200 rounded-lg cursor-pointer hover:border-[#f26e21] hover:bg-orange-50 transition-all group">
                                            <ImageIcon size={18} className="text-gray-300 group-hover:text-[#f26e21] flex-shrink-0 transition-colors" />
                                            <div>
                                                <p className="text-xs font-medium text-gray-400 group-hover:text-[#f26e21] transition-colors">
