                                ...
                                <div className="px-6 py-4 space-y-3">
                                    ...
                                    {preview && (
                                        <div>
                                            ...
                                            <div className="relative rounded-lg overflow-hidden border border-[#FF6B35]/40">
                                            ...
                                            <div className="flex gap-2 mt-2">
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 bg-[#FF6B35] hover:bg-[#E85A2A] text-white text-xs font-semibold px-4 py-2 rounded-lg transition-colors disabled:opacity-60"
                                                >
                                    ...
                                    {/* File selector */}
                                    {!preview && (
                                        <label className="flex items-center gap-3 px-4 py-3 border border-dashed border-gray-200 rounded-lg cursor-pointer hover:border-[#FF6B35] hover:bg-orange-50 transition-all group">
                                            <ImageIcon size={18} className="text-gray-300 group-hover:text-[#FF6B35] flex-shrink-0 transition-colors" />
                                            <div>
                                                <p className="text-xs font-medium text-gray-400 group-hover:text-[#FF6B35] transition-colors">
