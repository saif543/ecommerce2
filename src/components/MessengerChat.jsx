    ...
    <div className="fixed bottom-20 md:bottom-6 right-4 min-[480px]:right-6 z-[999]">
          ...
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-white text-sm font-semibold">ZenTech</p>
      ...
      >
        ...
        {open ? (
          ...
          <svg viewBox="0 0 24 24" fill="white" className="relative w-6 h-6 drop-shadow-[0_0_6px_rgba(15,52,96,0.6)]">
