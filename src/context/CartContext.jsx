...
function CartToast({ message, onClose }) {
  ...
  return (
    <motion.div
      ...
      className="fixed top-4 right-4 z-[9999] flex items-center gap-3 bg-[#111111] text-white pl-4 pr-5 py-3 rounded-xl shadow-lg shadow-black/30 border border-[#F47B20]/30 max-w-xs"
    >
      <CheckCircle2 size={20} className="text-[#FF9F43] flex-shrink-0" />
