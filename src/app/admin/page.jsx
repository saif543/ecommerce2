        ...
        <div className="flex h-screen bg-gray-50 overflow-hidden">
            ...
            <aside className="w-20 bg-gray-900 text-white flex flex-col">
                ...
                <div className="p-6 border-b border-gray-800 flex justify-center">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#FF6B35] to-[#E85A2A] rounded-lg flex items-center justify-center text-white font-bold text-xl">
                        N
                    </div>
                </div>
                            ...
                            <div className="bg-white rounded-xl p-6 border border-gray-200">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    ...
                                    <button
                                        ...
                                        className="p-4 border-2 border-gray-200 rounded-lg hover:border-[#FF6B35] hover:bg-orange-50 transition-all text-left"
                                    >
                                        <ImageIcon className="text-[#FF6B35] mb-2" size={24} />
                                    ...
                                    <button
                                        ...
                                        className="p-4 border-2 border-gray-200 rounded-lg hover:border-[#FF6B35] hover:bg-orange-50 transition-all text-left"
                                    >
                                        <ShoppingCart className="text-[#FF6B35] mb-2" size={24} />
